    ...
    <?php include'nav.php';?>
        <div class="container mt-3">
            ...
            <div class="body1">
                ...
                <a href="https://wa.me/Yor_phone no ?text=Hello Sir!%0A"><i class="fa-brands fa-whatsapp"></i></a>
                <a href="#"><i class="fa-brands fa-telegram"></i></a>
                <a href="mohitshakya35@gmail.com?subject=Buying idols"><i class="fa-solid fa-envelope"></i></a>
            </div>
            <div class="map mt-3">
